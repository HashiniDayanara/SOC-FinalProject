...
set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS25} [get_ports {gpio_i_0[6]}]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS25} [get_ports {gpio_i_0[7]}]
...
# set_property -dict {PACKAGE_PIN B7 IOSTANDARD LVCMOS25} [get_ports {hdmi_reset}]
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS25} [get_ports {resetn_0}]
...
# set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[8]}]
# set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[9]}]
# set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[10]}]
# set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[11]}]
# set_property -dict {PACKAGE_PIN C18 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[12]}]
# set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[13]}]
# set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[14]}]
# set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports {GPO1_0[15]}]

# On-board Buttons
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS25} [get_ports {gpio_i_0[0]}]
set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS25} [get_ports {gpio_i_0[1]}]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS25} [get_ports {gpio_i_0[2]}]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS25} [get_ports {gpio_i_0[3]}]
